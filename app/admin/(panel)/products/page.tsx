...
export default function AdminProductsPage() {
  ...
  async function loadProducts() {
    ...
    if (error) {
      ...
      setProducts((data ?? []).map((item) => ({ ...item, image_url: item.image_url || productImageSets[item.slug]?.[0] || null })));
    }
          ...
          >
            ...
            <div>
              ...
              {form.image_url && (
                <div className="mt-4">
                  <img
                    src={form.image_url || productImageSets[form.slug]?.[0] || "/image/about.jpeg"}
                    alt="Product preview"
                    className="h-48 w-full rounded-xl object-contain bg-zinc-900 p-2 md:w-80"
                  />
                </div>
              )}
            </div>
          ...
          {loading ? (
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              {products.map((product) => (
                <div
                  key={product.id}
                  className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-950 shadow-xl shadow-black/20"
                >
                  ...
                  <div className="aspect-[4/3] bg-zinc-900">
                    ...
                    {product.image_url ? (
                      <img
                        ...
                        alt={product.name}
                        className="h-full w-full object-contain bg-zinc-900 p-2"
                      />
                    ) : (
                  ...
                  <div className="p-6">
                    ...
                    <AdminImageOrderManager
                      ...
                      fallbackImages={productImageSets[product.slug] ?? []}
                    />

      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-8 text-lg leading-9 text-gray-300">
            ...
            Sachin Stone and Article is one of Rajasthan's trusted names
            in premium stone craftsmanship.

            We specialize in Temple Stone Work, CNC Stone Jali,
            Murti Making, Stone Carving, Hotel & Resort Projects,
            Railway Station Work and Custom Architectural Stone Designs.

...
const services: MenuItem[] = [
  { name: "Temple Stone Work", slug: "temple-stone-work" },
  { name: "CNC Stone Jali", slug: "cnc-stone-jali" },
  { name: "Murti Making", slug: "murti-making" },
  { name: "Stone Carving", slug: "stone-carving" },
  { name: "Stone Cutting", slug: "stone-cutting" },
  { name: "Architectural Stone Work", slug: "architectural-stone-work" },
  { name: "Hotel & Resort Stone Work", slug: "hotel-resort-stone-work" },
  { name: "Railway Station Stone Work", slug: "railway-station-stone-work" },
  { name: "Custom Architectural Stone Work", slug: "custom-architectural-stone-work" },
];
...
===================================================== */
  ...
  { name: "Marble Stone Murti", slug: "marble-stone-murti" },
  { name: "Marble Entry Gate", slug: "marble-entry-gate" },
  { name: "Stone Carved Wall Panel", slug: "stone-carved-wall-panel" },
  { name: "Stone Chhatri & Gazebo", slug: "stone-chhatri-gazebo" },
  { name: "Stone Doors & Frames", slug: "stone-doors-frames" },
  { name: "Stone Fountains", slug: "stone-fountains" },
  { name: "Stone Pillars & Columns", slug: "stone-pillars-columns" },
  { name: "Temple Stone Dome", slug: "temple-stone-dome" },
  { name: "Temple Stone Jali", slug: "temple-stone-jali" },
];
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-transparent backdrop-blur-md">
      ...
      >
        ...
        >
          <div className="relative h-16 w-16 overflow-hidden rounded-full border-2 border-yellow-500 brand-gold-border">
            <Image
              src="/image/logo.png"
          ...
          <div className="hidden text-center leading-none sm:block">
            <div className="text-xl font-bold tracking-[0.08em] text-yellow-500 sm:text-2xl">
              SACHIN
            </div>
            <div className="mt-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white sm:text-xs">
              STONE &amp; ARTICLE
            </div>
          </div>
        </Link>
